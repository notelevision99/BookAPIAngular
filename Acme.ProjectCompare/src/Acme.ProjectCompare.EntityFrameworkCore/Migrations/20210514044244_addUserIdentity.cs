    ...
    public partial class addUserIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationUnits", x => new { x.UserId, x.OrganizationUnitId });
                    table.ForeignKey(
                        name: "FK_OrganizationUnits_Users_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRoles_Users_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTokens_Users_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationUnits_IdentityUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_IdentityUserId",
                table: "UserRoles",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTokens_IdentityUserId",
                table: "UserTokens",
                column: "IdentityUserId");
        }
